...
function HeaderToolIcon(props: React.HTMLAttributes<HTMLButtonElement>) {
...
function HeaderImpl(props: LayoutProps) {
    ...
    const { setDrawMode } = useDrawStore();
