...
function LayerItemMome(props: LayerProps) {
    ...
    const { name, opacity, imageSrc, onSelect, onVisible, onCopy, onDelete, onChangeOpacity } = props;
        ...
        <div className="flex flex-col mb-2">
            <div className="flex-auto grid gap-3 grid-cols-3 group" onClick={onSelect}>
                ...
                <div className="flex items-center gap-2 ml-5">
                    <button className="hidden group-hover:flex" onClick={onCopy}>
                    ...
                    <button className="hidden group-hover:flex" onClick={onDelete}>
                    ...
                    <button className="hidden group-hover:flex" onClick={onVisible}>
